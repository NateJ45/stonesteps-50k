...
export function sectionsProjection(field = 'pageBuilder'): string {
  return `${field}[]{
    ...
    _type == "elevationSection" => {
      ...
      "race": *[_type == "race"][0]{
        gpxUrl,
        elevationProfile{ source, miles, gainFt, lossFt, lowFt, highFt, points[]{ mile, ft } }
      }
    },
...
export async function getRace() {
  return sanityFetch(
    `*[_type == "race"][0]{
      ...
      elevationProfile{ source, sampledAt, miles, gainFt, lossFt, lowFt, highFt, points[]{ mile, ft } },
